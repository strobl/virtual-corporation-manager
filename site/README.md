...
## Alpha 6 technical prerelease handoff

This site accompanies the **0.1.0-alpha.6 technical prerelease**. Apply the published-availability copy only after Engineering verifies the actual release, public archive download and displayed installation commands. The exact release asset is:

`https://github.com/strobl/virtual-corporation-manager/releases/download/v0.1.0-alpha.6/gitflash-0.1.0-alpha.6.tgz`
