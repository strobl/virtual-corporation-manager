...
- Keep pinned reference input and supporting files in new workflow ZIPs, carry the complete producer candidate through QA and handoff, and preserve previously sealed ZIP bytes under their original bundle format.
...
- Introduce **VCM — Virtual Corporation Manager** with a compact Home screen: **Run a task**, **Review results**, **Track delivery hours**, and **Set up a company**. Each action opens an existing working flow; an empty workspace retains the task intent through reviewed company setup. Opening an action does not dispatch a provider job.
...
The local candidate entries below are historical development records; their versions and evidence do not identify this release archive.
