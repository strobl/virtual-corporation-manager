...
export interface WorkRecord {
  ...
  title: string;
  output: string;
  provenance: 'manual' | 'codex' | 'buzz' | 'slack';
...
export type DomainCommand =
  ...
  | {
      type: 'company.update';
      id: string;
      input: Partial<Pick<Company, 'name' | 'shortCode' | 'description' | 'color'>>;
    }
  ...
  | {
      ...
      input: Partial<
        Pick<
          Agent,
          'name' | 'role' | 'instructions' | 'responsibilities' | 'departmentId' | 'managerId'
        >
      >;
    }
  ...
  | {
      ...
      input: Pick<
        Relationship,
        'fromCompanyId' | 'toCompanyId' | 'kind' | 'percentage' | 'description'
      >;
    }
