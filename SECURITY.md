...
Report suspected vulnerabilities through [GitHub private vulnerability reporting](https://github.com/strobl/virtual-corporation-manager/security/advisories/new), which is enabled for this repository. Include a minimal reproduction without unrelated private data. Security fixes receive priority; no response-time guarantee is promised.

On Windows, files inherit the selected directory’s OS ACLs; VCM does not guarantee Unix-style permission bits or create a separate Windows ACL policy. Choose a private user-owned data directory.
