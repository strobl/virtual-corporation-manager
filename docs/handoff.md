...
**Current product, 6 September 2026:** This checkout targets **0.1.0-alpha.7**. The [corporation-management contract](product/corporation-management.md) supersedes older task-first product assumptions: create a company, add people and AI agents, manage their responsibilities and relationships, and retain the existing Time Tracker. The company and member inspector share one context; execution and connection settings are secondary tools. See the current [first-company guide](first-company.md) and [release acceptance](acceptance.md#corporation-management-release--6-september-2026). Alpha.6 naming and all compatibility identifiers are retained. Older release and workflow records below are historical evidence; this revision does not close runtime, integration or human-usefulness gaps.

**Branding maintenance, 6 September 2026:** This checkout prepares **0.1.0-alpha.6** with consistent VCM product copy and `vcm` command examples. Follow the [naming contract](branding.md) and [current release acceptance](acceptance.md#branding-maintenance-release--6-september-2026). The original Agent Operations import receipt and source manifest remain preserved; [branding adaptations](agent-operations/branding-receipt.json) identify the current shipped documentation. Final checks and public release verification are separate from the dated alpha.5 records below.

**Technical prerelease, 6 September 2026:** [VCM alpha.5 is published](https://github.com/strobl/virtual-corporation-manager/releases/tag/v0.1.0-alpha.5) from reviewed source `7807649`, merged as `2b75b16` with an unchanged source tree. Source, PR and merge CI each passed all 17 jobs. The release manifest binds the frozen archive, source/privacy/license review and independent public-download/install/recovery record. [Current acceptance](acceptance.md#technical-prerelease--6-september-2026) supersedes the pending publication statuses in the dated preparation snapshots below. That alpha.5 documentation follow-up did not change its released package.
